...
- Painel administrativo próprio (login + editar produtos/estoque/frete sem entrar no Supabase): **adiado a pedido do Johnny**, ele está usando o Table Editor do Supabase por enquanto. Retomar quando ele pedir.
